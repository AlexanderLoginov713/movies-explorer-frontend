...
function transformMovies(movies) {
  movies.forEach(movie => {
    if (!movie.image) {
      movie.image = 'https://i.ibb.co/Sc6v8QR/noom-peerapong-2uw-FEAGUm6-E-unsplash-1.jpg';
      movie.thumbnail = 'https://i.ibb.co/Sc6v8QR/noom-peerapong-2uw-FEAGUm6-E-unsplash-1.jpg';
    } else {
